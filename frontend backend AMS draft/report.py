...
class ReportFrame(BaseFrame):
    ...
    def create_widgets(self):
        ...
        dashboard_bg_image = PIL.Image.open("images/reportbg.jpg")
        ...
        # Report Label
        ReportLabel = ctk.CTkLabel(master=self, text="Report", fg_color="White",
                                      text_color="#3D291F", font=("Century Gothic", 45, "bold"))
        ReportLabel.place(relx=0.23, rely=0.18)
