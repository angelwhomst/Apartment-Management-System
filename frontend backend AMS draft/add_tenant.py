...
class AddTenantComponent:
    ...
    def create_widgets(self, parent):
        ...
        self.entry_tenant_name = CTkEntry(parent, placeholder_text="Enter tenant name", width=240, height=25, border_color="#937A69",
        ...
        self.entry_unit_number = CTkEntry(parent, placeholder_text="Enter unit number", width=240, height=25, border_color="#937A69",
                                          font=('Century Gothic', 12))
        ...
        self.entry_last_payment = DateEntry(parent, width=20, background='#937A69', foreground='#937A69', borderwidth=2,selectbackground='#937A69',
                                            font=('Century Gothic', 12))
